...
::Xml Xml_obj::get_parent( ){
	HX_STACK_FRAME("Xml","get_parent",0x6149124a,"Xml.get_parent","/usr/lib/haxe/std/cpp/_std/Xml.hx",194,0x13595685)
	HX_STACK_THIS(this)
	HX_STACK_LINE(194)
	return this->_parent;
}
...
Dynamic Xml_obj::attributes( ){
	HX_STACK_FRAME("Xml","attributes",0x1ab5462e,"Xml.attributes","/usr/lib/haxe/std/cpp/_std/Xml.hx",225,0x13595685)
	HX_STACK_THIS(this)
	HX_STACK_LINE(226)
	if (((this->nodeType != ::Xml_obj::Element))){
		HX_STACK_LINE(227)
...
::Xml Xml_obj::firstChild( ){
	HX_STACK_FRAME("Xml","firstChild",0x06db90a3,"Xml.firstChild","/usr/lib/haxe/std/cpp/_std/Xml.hx",305,0x13595685)
	HX_STACK_THIS(this)
	HX_STACK_LINE(306)
	if (((this->_children == null()))){
		HX_STACK_LINE(307)
...
::String Xml_obj::toString( ){
	HX_STACK_FRAME("Xml","toString",0xb7bb9a43,"Xml.toString","/usr/lib/haxe/std/cpp/_std/Xml.hx",348,0x13595685)
	HX_STACK_THIS(this)
	HX_STACK_LINE(349)
...
{
		HX_STACK_FRAME("Xml","toStringRec",0x868882cd,"Xml.toStringRec","/usr/lib/haxe/std/cpp/_std/Xml.hx",355,0x13595685)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(355)

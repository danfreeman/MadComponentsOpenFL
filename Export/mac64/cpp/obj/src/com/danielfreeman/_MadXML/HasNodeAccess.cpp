...
{
HX_STACK_FRAME("com.danielfreeman._MadXML.HasNodeAccess","new",0xc4a0ee1e,"com.danielfreeman._MadXML.HasNodeAccess.new","com/danielfreeman/MadXML.hx",66,0xb248a369)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(66)
...
bool HasNodeAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("com.danielfreeman._MadXML.HasNodeAccess","resolve",0xdb21e7aa,"com.danielfreeman._MadXML.HasNodeAccess.resolve","com/danielfreeman/MadXML.hx",70,0xb248a369)
	HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.danielfreeman._MadXML.HasNodeAccess"), hx::TCanCast< HasNodeAccess_obj> ,sStaticFields,sMemberFields,

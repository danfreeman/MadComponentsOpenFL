...
{
HX_STACK_FRAME("com.danielfreeman._MadXML.AttribAccess","new",0xc701f214,"com.danielfreeman._MadXML.AttribAccess.new","com/danielfreeman/MadXML.hx",31,0xb248a369)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(31)
...
::String AttribAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("com.danielfreeman._MadXML.AttribAccess","resolve",0xfa531ea0,"com.danielfreeman._MadXML.AttribAccess.resolve","com/danielfreeman/MadXML.hx",34,0xb248a369)
	HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.danielfreeman._MadXML.AttribAccess"), hx::TCanCast< AttribAccess_obj> ,sStaticFields,sMemberFields,

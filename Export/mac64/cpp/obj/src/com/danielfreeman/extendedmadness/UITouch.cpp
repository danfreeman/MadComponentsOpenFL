...
Void UITouch_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	HX_STACK_LINE(44)
	::com::danielfreeman::MadXML _g8 = ::com::danielfreeman::MadXML_obj::parse(_g7);		HX_STACK_VAR(_g8,"_g8");
	HX_STACK_LINE(44)
...
hx::ObjectPtr< UITouch_obj > UITouch_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)

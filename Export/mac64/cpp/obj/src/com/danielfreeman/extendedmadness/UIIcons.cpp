...
Void UIIcons_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	if ((xml->hasNode->resolve(HX_CSTRING("font")))){
		HX_STACK_LINE(135)
		::com::danielfreeman::MadXML _g14 = xml->node->resolve(HX_CSTRING("font"));		HX_STACK_VAR(_g14,"_g14");
		HX_STACK_LINE(135)
	...
	if ((xml->hasNode->resolve(HX_CSTRING("activeFont")))){
		HX_STACK_LINE(138)
		::com::danielfreeman::MadXML _g16 = xml->node->resolve(HX_CSTRING("activeFont"));		HX_STACK_VAR(_g16,"_g16");
		HX_STACK_LINE(138)
	...
	if ((xml->hasNode->resolve(HX_CSTRING("disableFont")))){
		HX_STACK_LINE(141)
		::com::danielfreeman::MadXML _g18 = xml->node->resolve(HX_CSTRING("disableFont"));		HX_STACK_VAR(_g18,"_g18");
		HX_STACK_LINE(141)
	...
	HX_STACK_LINE(146)
	::com::danielfreeman::MadXML _g20 = this->doDeletes(xml);		HX_STACK_VAR(_g20,"_g20");
	HX_STACK_LINE(146)
	xml = _g20;
...
hx::ObjectPtr< UIIcons_obj > UIIcons_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
::com::danielfreeman::MadXML UIIcons_obj::doDeletes( ::com::danielfreeman::MadXML xml){
	...
	for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(xml->children(null())->iterator());  __it->hasNext(); ){
		::com::danielfreeman::MadXML child = __it->next();
		{
			...
			struct _Function_2_1{
				inline static bool Block( ::com::danielfreeman::MadXML &child,Array< ::String > &exclude){
...
;
	...
	HX_STACK_LINE(164)
	return ::com::danielfreeman::MadXML_obj::parse((result + HX_CSTRING("</icons>")));
}


HX_DEFINE_DYNAMIC_FUNC1(UIIcons_obj,doDeletes,return )

Void UIIcons_obj::extractData( ::com::danielfreeman::MadXML xml){
{
		...
		HX_STACK_ARG(xml,"xml")
		HX_STACK_LINE(169)
		for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(xml->nodes->resolve(HX_CSTRING("data"))->iterator());  __it->hasNext(); ){
			::com::danielfreeman::MadXML data = __it->next();
			if ((!(data->has->resolve(HX_CSTRING("size"))))){
				...
				struct _Function_2_1{
					inline static bool Block( ::com::danielfreeman::MadXML &data){
...
::String UIIcons_obj::imageAttributeText( ::com::danielfreeman::MadXML item){
...
::com::danielfreeman::MadXML UIIcons_obj::set_xmlData( ::com::danielfreeman::MadXML value){
	...
	this->_text = HX_CSTRING("");
	HX_STACK_LINE(219)
	for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(value->children(null())->iterator());  __it->hasNext(); ){

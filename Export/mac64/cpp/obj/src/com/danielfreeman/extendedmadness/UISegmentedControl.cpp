...
Void UISegmentedControl_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	if ((xml->hasNode->resolve(HX_CSTRING("font")))){
		HX_STACK_LINE(78)
		::com::danielfreeman::MadXML _g3 = xml->node->resolve(HX_CSTRING("font"));		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(78)
		this->_font = _g3;
	}
	HX_STACK_LINE(80)
...
hx::ObjectPtr< UISegmentedControl_obj > UISegmentedControl_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UISegmentedControl_obj::initialise( Array< ::String > words){
{
		...
		if ((this->_xml->hasNode->resolve(HX_CSTRING("data")))){
			HX_STACK_LINE(131)
			::com::danielfreeman::MadXML _g8 = this->_xml->node->resolve(HX_CSTRING("data"));		HX_STACK_VAR(_g8,"_g8");
			HX_STACK_LINE(131)
...
::com::danielfreeman::MadXML UISegmentedControl_obj::set_xmlData( ::com::danielfreeman::MadXML value){
...
Array< ::String > UISegmentedControl_obj::extractData( ::com::danielfreeman::MadXML xml){
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::com::danielfreeman::MadXML*/ ,(int)offsetof(UISegmentedControl_obj,_xml),HX_CSTRING("_xml")},

...
::com::danielfreeman::MadXML UICutCopyPaste_obj::set_font( ::com::danielfreeman::MadXML value){
...
Dynamic UICutCopyPaste_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"_font") ) { _font=inValue.Cast< ::com::danielfreeman::MadXML >(); return inValue; }
		break;
	case 6:
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::com::danielfreeman::MadXML*/ ,(int)offsetof(UICutCopyPaste_obj,_font),HX_CSTRING("_font")},

...
Void UIContainerBaseClass_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UIContainerBaseClass_obj > UIContainerBaseClass_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UIContainerBaseClass_obj::initialise( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{
...
::com::danielfreeman::MadXML UIContainerBaseClass_obj::get_xml( ){
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::com::danielfreeman::MadXML*/ ,(int)offsetof(UIContainerBaseClass_obj,_xml),HX_CSTRING("_xml")},
	{ hx::fsUnknown, 0, null()}
};
#endif

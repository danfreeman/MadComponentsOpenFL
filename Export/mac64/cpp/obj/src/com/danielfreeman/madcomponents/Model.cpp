...
Void Model_obj::__construct(::openfl::display::Sprite parent,::com::danielfreeman::MadXML xml,::com::danielfreeman::MadXML sendXml)
{
...
HX_STACK_ARG(sendXml,"sendXml")
{
	...
	if (((xml != null()))){
		...
		HX_STACK_LINE(102)
		::com::danielfreeman::MadXML _g1;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(102)
		if (((_g > (int)0))){
			HX_STACK_LINE(102)
	...
	if (((sendXml != null()))){
		HX_STACK_LINE(126)
		::com::danielfreeman::MadXMLList sendChildren = sendXml->children(null());		HX_STACK_VAR(sendChildren,"sendChildren");
		HX_STACK_LINE(127)
		::com::danielfreeman::MadXML _g9 = sendChildren->get((int)0);		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(127)
...
hx::ObjectPtr< Model_obj > Model_obj::__new(::openfl::display::Sprite parent,::com::danielfreeman::MadXML xml,::com::danielfreeman::MadXML sendXml)
...
Dynamic Model_obj::set_dataAMF( Dynamic value){
	...
	if ((::Std_obj::is(this->_parent,hx::ClassOf< ::com::danielfreeman::madcomponents::UIList >()))){
		...
		if (((this->_schema == null()))){
			...
			HX_STACK_LINE(271)
			{
				...
				while((true)){
					...
					++(_g);
					HX_STACK_LINE(272)
					::com::danielfreeman::MadXML _g2 = this->_schema->parent();		HX_STACK_VAR(_g2,"_g2");
		...
		if (((this->_schema == null()))){
			...
			HX_STACK_LINE(282)
			::com::danielfreeman::MadXML _g3 = this->_schema->parent();		HX_STACK_VAR(_g3,"_g3");
...
Dynamic Model_obj::parseAMFlist( Dynamic record,::com::danielfreeman::MadXML schema,Dynamic result,::String __o_path){
...
{
		HX_STACK_LINE(313)
		::com::danielfreeman::MadXMLList schemaChildren = schema->children(null());		HX_STACK_VAR(schemaChildren,"schemaChildren");
		HX_STACK_LINE(314)
		for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(schemaChildren->iterator());  __it->hasNext(); ){
...
::com::danielfreeman::MadXML Model_obj::set_dataXML( ::com::danielfreeman::MadXML xml){
	...
	HX_STACK_ARG(xml,"xml")
	HX_STACK_LINE(400)
	::com::danielfreeman::MadXML schema = this->_schema;		HX_STACK_VAR(schema,"schema");
	HX_STACK_LINE(401)
	::com::danielfreeman::MadXML _g = this->xmlPath(xml,this->_path);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(401)
	xml = _g;
	HX_STACK_LINE(402)
	if (((bool((this->_path != HX_CSTRING(""))) && bool((this->_schema != null()))))){
		HX_STACK_LINE(403)
		::com::danielfreeman::MadXML _g1 = this->_schema->parent();		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(403)
		schema = _g1;
	}
	HX_STACK_LINE(405)
...
Dynamic Model_obj::listData( ::com::danielfreeman::MadXML xml,::com::danielfreeman::MadXML schema){
	...
	HX_STACK_LINE(429)
	::com::danielfreeman::MadXMLList items = xml->children(null());		HX_STACK_VAR(items,"items");
	HX_STACK_LINE(430)
	if (((schema == null()))){
		HX_STACK_LINE(431)
		result = Dynamic( Array_obj<Dynamic>::__new());
		struct _Function_2_1{
			inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::madcomponents::Model_obj > __this,::com::danielfreeman::MadXML &item0){
		...
		HX_STACK_LINE(432)
		for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(items->iterator());  __it->hasNext(); ){
			::com::danielfreeman::MadXML item0 = __it->next();
...
;
		...
		struct _Function_2_1{
			inline static bool Block( ::com::danielfreeman::MadXMLList &schemaChildren){
		...
		if (((  (((  (((_g2 == (int)1))) ? bool(_Function_2_1::Block(schemaChildren)) : bool(false) ))) ? bool(schemaChildren->get((int)0)->get_hasChildren()) : bool(false) ))){
			HX_STACK_LINE(440)
			::com::danielfreeman::MadXML _g4 = items->get((int)0);		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(440)
			::com::danielfreeman::MadXML _g5 = schemaChildren->get((int)0);		HX_STACK_VAR(_g5,"_g5");
			HX_STACK_LINE(440)
		...
		if (((_g7 > (int)1))){
			...
			result = Dynamic( Array_obj<Dynamic>::__new());
			HX_STACK_LINE(447)
			::com::danielfreeman::MadXMLList schemaGrandChildren = schemaChildren->get((int)0)->children(null());		HX_STACK_VAR(schemaGrandChildren,"schemaGrandChildren");
			HX_STACK_LINE(448)
			for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(items->iterator());  __it->hasNext(); ){
				::com::danielfreeman::MadXML item = __it->next();
				{
					HX_STACK_LINE(449)
					...
					if (((_g9 > (int)0))){
						...
						HX_STACK_LINE(451)
						::com::danielfreeman::MadXML _g10 = schemaChildren->get((int)0);		HX_STACK_VAR(_g10,"_g10");
						HX_STACK_LINE(451)
...
Void Model_obj::attributeValues( ::com::danielfreeman::MadXML item,::com::danielfreeman::MadXML childSchema,Dynamic result){
{
...
Dynamic Model_obj::listValues( ::com::danielfreeman::MadXML item,::com::danielfreeman::MadXML childSchema){
	...
	if (((childSchema == null()))){
		...
		if ((!(item->get_hasChildren()))){
			...
			this->attributeValues(item,childSchema,result);
			HX_STACK_LINE(486)
			::com::danielfreeman::MadXMLList _g = childSchema->children(null());		HX_STACK_VAR(_g,"_g");
			HX_STACK_LINE(486)
...
Dynamic Model_obj::listObject( ::com::danielfreeman::MadXML item,::com::danielfreeman::MadXMLList childSchema,Dynamic result){
	...
	if (((result == null()))){
		...
		struct _Function_2_2{
			inline static bool Block( ::com::danielfreeman::MadXMLList &childSchema){
	...
	HX_STACK_LINE(503)
	for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(childSchema->iterator());  __it->hasNext(); ){
		::com::danielfreeman::MadXML child = __it->next();
		if ((!(child->get_nodeKindIsText()))){
			...
			if ((!(child->get_hasChildren()))){
				...
				HX_STACK_LINE(511)
				::com::danielfreeman::MadXML _g1 = item->child0(tagName);		HX_STACK_VAR(_g1,"_g1");
				HX_STACK_LINE(511)
				...
				HX_STACK_LINE(516)
				::com::danielfreeman::MadXML _g3 = item->child0(tagName);		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(516)
				::com::danielfreeman::MadXML _g4 = child->child0(null());		HX_STACK_VAR(_g4,"_g4");
				HX_STACK_LINE(516)
				this->attributeValues(_g3,_g4,result);
				HX_STACK_LINE(517)
				::com::danielfreeman::MadXML _g5 = item->child0(tagName);		HX_STACK_VAR(_g5,"_g5");
				HX_STACK_LINE(517)
				::com::danielfreeman::MadXMLList _g6 = child->children(null());		HX_STACK_VAR(_g6,"_g6");
				HX_STACK_LINE(517)
...
Dynamic Model_obj::xmlToObject( ::com::danielfreeman::MadXML xml){
...
::com::danielfreeman::MadXML Model_obj::xmlPath( ::com::danielfreeman::MadXML xml,::String path){
	...
	HX_STACK_LINE(545)
	{
		...
		while((true)){
			...
			HX_STACK_LINE(546)
			::com::danielfreeman::MadXML _g11 = ::com::danielfreeman::MadXML_obj::__new(_g2);		HX_STACK_VAR(_g11,"_g11");
			HX_STACK_LINE(546)
			xml = _g11;
		}
	}
	...
	HX_STACK_ARG(sendBy,"sendBy")
{
		...
		HX_STACK_LINE(558)
		::com::danielfreeman::MadXML result = ::com::danielfreeman::MadXML_obj::parse(_g);		HX_STACK_VAR(result,"result");
		HX_STACK_LINE(559)
...
Void Model_obj::substitute( ::com::danielfreeman::MadXML data){
{
		...
		HX_STACK_LINE(566)
		for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(data->children(null())->iterator());  __it->hasNext(); ){
			::com::danielfreeman::MadXML item = __it->next();
			if ((!(item->get_hasChildren()))){
				HX_STACK_LINE(568)
...
Dynamic Model_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"_schema") ) { _schema=inValue.Cast< ::com::danielfreeman::MadXML >(); return inValue; }
	...
	case 8:
		...
		break;
	case 11:
		if (HX_FIELD_EQ(inName,"_sendSchema") ) { _sendSchema=inValue.Cast< ::com::danielfreeman::MadXML >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::com::danielfreeman::MadXML*/ ,(int)offsetof(Model_obj,_schema),HX_CSTRING("_schema")},
	{hx::fsObject /*::com::danielfreeman::MadXML*/ ,(int)offsetof(Model_obj,_sendSchema),HX_CSTRING("_sendSchema")},

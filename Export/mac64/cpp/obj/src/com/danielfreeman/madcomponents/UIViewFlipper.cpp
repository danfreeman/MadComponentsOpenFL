...
Void UIViewFlipper_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UIViewFlipper_obj > UIViewFlipper_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UIViewFlipper_obj::layout( ::com::danielfreeman::madcomponents::Attributes attributes0){
{
		...
		this->drawComponent();
		HX_STACK_LINE(94)
		::com::danielfreeman::MadXMLList children = this->get_xml()->children(null());		HX_STACK_VAR(children,"children");
		HX_STACK_LINE(95)
		{
			HX_STACK_LINE(95)
			...
			while((true)){
				...
				HX_STACK_LINE(96)
				::com::danielfreeman::MadXML pageXML = children->get(i);		HX_STACK_VAR(pageXML,"pageXML");
				HX_STACK_LINE(98)
				::com::danielfreeman::madcomponents::Attributes newAttributes = attributes->copy(null(),null());		HX_STACK_VAR(newAttributes,"newAttributes");
				HX_STACK_LINE(99)
				Float shiftX = (i * this->_width);		HX_STACK_VAR(shiftX,"shiftX");
				struct _Function_3_1{
					inline static bool Block( ::com::danielfreeman::MadXML &pageXML){
...
Void UIViewFlipper_obj::createSlider( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{
		...
		HX_STACK_LINE(140)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(142)
				::com::danielfreeman::MadXML child = ::com::danielfreeman::MadXML_obj::parse(_g4);		HX_STACK_VAR(child,"child");
				HX_STACK_LINE(143)
				::com::danielfreeman::madcomponents::Attributes newAttributes = attributes->copy(null(),null());		HX_STACK_VAR(newAttributes,"newAttributes");
				HX_STACK_LINE(144)
				Float shiftX = (i * this->_width);		HX_STACK_VAR(shiftX,"shiftX");
		...
		if (((this->_distance > 8.0))){
			...
			struct _Function_2_1{
				inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::madcomponents::UIViewFlipper_obj > __this){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIViewFlipper.hx",206,0x839f3b9e)
					{
						HX_STACK_LINE(206)
						int _g6 = __this->_touchTimer->get_currentCount();		HX_STACK_VAR(_g6,"_g6");
						HX_STACK_LINE(206)
						return (_g6 == (int)3);
					}
					return null();
			...
			HX_STACK_LINE(206)
			if (((  ((this->_classic)) ? bool(_Function_2_1::Block(this)) : bool(false) ))){
				HX_STACK_LINE(207)
				this->pressButton(null());
			}
			else{
				HX_STACK_LINE(209)
				int _g7 = this->_touchTimer->get_currentCount();		HX_STACK_VAR(_g7,"_g7");
				struct _Function_3_1{
					inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::madcomponents::UIViewFlipper_obj > __this){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIViewFlipper.hx",209,0x839f3b9e)
						{
							HX_STACK_LINE(209)
							Float _g8 = ::Math_obj::abs(__this->_delta);		HX_STACK_VAR(_g8,"_g8");
							HX_STACK_LINE(209)
							return (_g8 <= 2.0);
						}
						return null();
				...
				HX_STACK_LINE(209)
				if (((  (((  (((_g7 == (int)8))) ? bool(!(this->_classic)) : bool(false) ))) ? bool(_Function_3_1::Block(this)) : bool(false) ))){
					HX_STACK_LINE(210)
					this->pressButton(null());
				}
			}
...
bool UIViewFlipper_obj::slideCondition( ){
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::madcomponents::UIViewFlipper_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIViewFlipper.hx",216,0x839f3b9e)
			{
				...
				HX_STACK_LINE(216)
				int _g3 = __this->_touchTimer->get_currentCount();		HX_STACK_VAR(_g3,"_g3");
				HX_STACK_LINE(216)
	...
	if (((  (((this->_pressButton == null()))) ? bool(_Function_1_1::Block(this)) : bool(false) ))){
		HX_STACK_LINE(216)
		int _g5 = this->_touchTimer->get_currentCount();		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(216)
		return (_g5 < (int)5);
	}
	else{

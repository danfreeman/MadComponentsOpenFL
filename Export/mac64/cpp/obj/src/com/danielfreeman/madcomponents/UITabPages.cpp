...
Void UITabPages_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UITabPages_obj > UITabPages_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UITabPages_obj::extractData( ::com::danielfreeman::MadXML xml){
{
		...
		if ((xml->hasNode->resolve(HX_CSTRING("data")))){
			...
			if ((!(xml->node->resolve(HX_CSTRING("data"))->has->resolve(HX_CSTRING("size"))))){
				HX_STACK_LINE(103)
				::com::danielfreeman::MadXML _g = xml->node->resolve(HX_CSTRING("data"));		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(103)
				this->set_xmlData(_g);
				HX_STACK_LINE(104)
				return null();
				...
				if (((  (((_g1 == HX_CSTRING("DPI")))) ? bool(_Function_3_1::Block(xml)) : bool(false) ))){
					HX_STACK_LINE(107)
					::com::danielfreeman::MadXML _g5 = xml->node->resolve(HX_CSTRING("data"));		HX_STACK_VAR(_g5,"_g5");
					HX_STACK_LINE(107)
...
::com::danielfreeman::MadXML UITabPages_obj::set_xmlData( ::com::danielfreeman::MadXML value){
...
Dynamic UITabPages_obj::attributesToObject( ::com::danielfreeman::MadXML child){
...
Void UITabPages_obj::initialiseButtonBar( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{

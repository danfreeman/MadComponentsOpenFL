...
Void UIList_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	HX_STACK_LINE(190)
	::com::danielfreeman::MadXML _g13 = this->extractRenderer(xml);		HX_STACK_VAR(_g13,"_g13");
	HX_STACK_LINE(190)
	this->_renderer = _g13;
	HX_STACK_LINE(191)
	...
	if ((xml->hasNode->resolve(HX_CSTRING("data")))){
		HX_STACK_LINE(217)
		::com::danielfreeman::MadXML _g25 = xml->node->resolve(HX_CSTRING("data"));		HX_STACK_VAR(_g25,"_g25");
		HX_STACK_LINE(217)
	...
	if ((xml->hasNode->resolve(HX_CSTRING("model")))){
		HX_STACK_LINE(220)
		::com::danielfreeman::MadXML _g26 = xml->node->resolve(HX_CSTRING("model"));		HX_STACK_VAR(_g26,"_g26");
		HX_STACK_LINE(220)
...
hx::ObjectPtr< UIList_obj > UIList_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UIList_obj::addASearch( ::com::danielfreeman::MadXML xml){
{
		...
		HX_STACK_ARG(xml,"xml")
		HX_STACK_LINE(231)
		::com::danielfreeman::MadXML _g = xml->node->resolve(HX_CSTRING("search"));		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(231)
		...
		HX_STACK_LINE(233)
		::com::danielfreeman::MadXML _g2 = xml->node->resolve(HX_CSTRING("search"));		HX_STACK_VAR(_g2,"_g2");
		HX_STACK_LINE(233)
...
::com::danielfreeman::MadXML UIList_obj::set_rendererXML( ::com::danielfreeman::MadXML value){
...
Void UIList_obj::initialiseRenderAttributes( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{
...
::com::danielfreeman::MadXML UIList_obj::get_rendererXML( ){
...
::com::danielfreeman::MadXML UIList_obj::extractRenderer( ::com::danielfreeman::MadXML xml){
...
Void UIList_obj::dispatchClickedEnd( ){
{
		...
		if ((!(this->_classic))){
			...
			HX_STACK_LINE(416)
			::openfl::events::Event _g7 = ::openfl::events::Event_obj::__new(HX_CSTRING("listClickedEnd"),true,true);		HX_STACK_VAR(_g7,"_g7");
			HX_STACK_LINE(416)
...
::com::danielfreeman::MadXML UIList_obj::set_xmlData( ::com::danielfreeman::MadXML value){
	...
	HX_STACK_LINE(443)
	::com::danielfreeman::MadXMLList children = value->children(null());		HX_STACK_VAR(children,"children");
	HX_STACK_LINE(444)
	for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(children->iterator());  __it->hasNext(); ){
		::com::danielfreeman::MadXML child = __it->next();
...
Dynamic UIList_obj::attributesToObject( ::com::danielfreeman::MadXML child){
...
Void UIList_obj::createSlider( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{
...
::com::danielfreeman::madcomponents::UILabel UIList_obj::labelCell( Dynamic record,Float position){
	...
	label->set_name(_g2);
	HX_STACK_LINE(759)
	::com::danielfreeman::MadXML xml = ::com::danielfreeman::MadXML_obj::parse(((HX_CSTRING("<t>") + labelText) + HX_CSTRING("</t>")));		HX_STACK_VAR(xml,"xml");
	HX_STACK_LINE(760)
		...
		if (((bool(!(this->_classic)) && bool(this->_rowClick)))){
			...
			struct _Function_2_1{
				inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::madcomponents::UIList_obj > __this){
					...
					{
						HX_STACK_LINE(1015)
						Float _g1 = ::Math_obj::abs(__this->_delta);		HX_STACK_VAR(_g1,"_g1");
						HX_STACK_LINE(1015)
						return (_g1 > 2.0);
					}
					return null();
			...
			HX_STACK_LINE(1015)
			if (((  ((!(((_g < ::com::danielfreeman::madcomponents::UIList_obj::TOUCH_THRESHOLD))))) ? bool(_Function_2_1::Block(this)) : bool(true) ))){
				HX_STACK_LINE(1016)
				this->doCancel();
			}
			else{
...
::openfl::display::DisplayObject UIList_obj::newRow( ::com::danielfreeman::MadXML rendererXML){
...
Void UIList_obj::customCell( Dynamic record,Float position){
{
		...
		HX_STACK_ARG(position,"position")
		HX_STACK_LINE(1127)
		::com::danielfreeman::MadXML _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1127)
		if ((::Reflect_obj::hasField(record,HX_CSTRING("_renderer")))){
			HX_STACK_LINE(1127)
			_g = ::com::danielfreeman::MadXML_obj::parse(record->__Field(HX_CSTRING("_renderer"),true));
		}
		else{
			HX_STACK_LINE(1127)
			_g = this->_renderer;
...
Void UIList_obj::mouseMove( ::openfl::events::TimerEvent event){
{
		...
		struct _Function_1_2{
			inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::madcomponents::UIList_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIList.hx",1247,0x418b0955)
				{
					HX_STACK_LINE(1247)
					int _g2 = __this->_touchTimer->get_currentCount();		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(1247)
					return (_g2 == ::com::danielfreeman::madcomponents::UIList_obj::LONG_CLICK_THRESHOLD);
				}
				return null();
			}
		};
		HX_STACK_LINE(1247)
		if (((  (((bool(this->_rowClick) && bool((this->_distance < 8.0))))) ? bool(_Function_1_2::Block(this)) : bool(false) ))){
			HX_STACK_LINE(1248)
			::openfl::events::Event _g3 = ::openfl::events::Event_obj::__new(HX_CSTRING("longClick"),null(),null());		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(1248)
...
Dynamic UIList_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 9:
		...
		if (HX_FIELD_EQ(inName,"_renderer") ) { _renderer=inValue.Cast< ::com::danielfreeman::MadXML >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::com::danielfreeman::MadXML*/ ,(int)offsetof(UIList_obj,_renderer),HX_CSTRING("_renderer")},

...
Void UIGroupedList_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UIGroupedList_obj > UIGroupedList_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
::com::danielfreeman::MadXML UIGroupedList_obj::set_rendererXML( ::com::danielfreeman::MadXML value){
...
::com::danielfreeman::MadXML UIGroupedList_obj::set_xmlData( ::com::danielfreeman::MadXML value){
	...
	for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(children->iterator());  __it->hasNext(); ){
		::com::danielfreeman::MadXML group = __it->next();
		{
			HX_STACK_LINE(737)
			...
			HX_STACK_LINE(745)
			for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(group->children(null())->iterator());  __it->hasNext(); ){

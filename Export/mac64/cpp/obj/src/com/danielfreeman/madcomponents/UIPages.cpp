...
Void UIPages_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	HX_STACK_LINE(150)
	::com::danielfreeman::AnimationTimer _g10 = ::com::danielfreeman::AnimationTimer_obj::__new(hx::ObjectPtr<OBJ_>(this),::com::danielfreeman::madcomponents::UIPages_obj::STEPS);		HX_STACK_VAR(_g10,"_g10");
	HX_STACK_LINE(150)
	this->_slideTimer = _g10;
	HX_STACK_LINE(151)
	::com::danielfreeman::MadXMLList children = xml->children(null());		HX_STACK_VAR(children,"children");
	HX_STACK_LINE(152)
	int index = (int)0;		HX_STACK_VAR(index,"index");
	struct _Function_1_1{
		inline static bool Block( ::com::danielfreeman::MadXML &child0){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIPages.hx",154,0x6e5fd425)
			{
				HX_STACK_LINE(154)
				::String _g11 = child0->get_name();		HX_STACK_VAR(_g11,"_g11");
				HX_STACK_LINE(154)
				return (_g11 != HX_CSTRING("data"));
			}
			return null();
		}
	};
	HX_STACK_LINE(153)
	for(::cpp::FastIterator_obj< ::com::danielfreeman::MadXML > *__it = ::cpp::CreateFastIterator< ::com::danielfreeman::MadXML >(children->iterator());  __it->hasNext(); ){
		::com::danielfreeman::MadXML child0 = __it->next();
		if (((  ((!(child0->get_nodeKindIsText()))) ? bool(_Function_1_1::Block(child0)) : bool(false) ))){
			...
			if ((xml->has->resolve(HX_CSTRING("lazyRender")))){
				HX_STACK_LINE(156)
				_g12 = xml->att->resolve(HX_CSTRING("lazyRender"));
			}
			else{
				HX_STACK_LINE(156)
				_g12 = HX_CSTRING("");
			...
			HX_STACK_LINE(156)
			::String _g13 = (HX_CSTRING("<page lazyRender=\"") + _g12);		HX_STACK_VAR(_g13,"_g13");
			HX_STACK_LINE(156)
			::String _g14 = (_g13 + HX_CSTRING("\" recycle=\""));		HX_STACK_VAR(_g14,"_g14");
			HX_STACK_LINE(156)
			::String _g15;		HX_STACK_VAR(_g15,"_g15");
			HX_STACK_LINE(156)
			if ((xml->has->resolve(HX_CSTRING("recycle")))){
				HX_STACK_LINE(156)
				_g15 = xml->att->resolve(HX_CSTRING("recycle"));
			}
			else{
				HX_STACK_LINE(156)
				_g15 = HX_CSTRING("");
			...
			HX_STACK_LINE(156)
			::String _g18 = (_g17 + childstr);		HX_STACK_VAR(_g18,"_g18");
			HX_STACK_LINE(156)
			::String _g19 = (_g18 + HX_CSTRING("</page>"));		HX_STACK_VAR(_g19,"_g19");
			HX_STACK_LINE(156)
			::com::danielfreeman::MadXML child = ::com::danielfreeman::MadXML_obj::parse(_g19);		HX_STACK_VAR(child,"child");
			HX_STACK_LINE(157)
			int _g20 = (index)++;		HX_STACK_VAR(_g20,"_g20");
			HX_STACK_LINE(157)
			::com::danielfreeman::madcomponents::Attributes newAttributes = this->childAttributes(_g20);		HX_STACK_VAR(newAttributes,"newAttributes");
			HX_STACK_LINE(158)
			newAttributes->parse(child0);
			struct _Function_2_1{
				inline static bool Block( ::com::danielfreeman::MadXML &child0){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIPages.hx",159,0x6e5fd425)
					{
						HX_STACK_LINE(159)
						::String _g21 = child0->att->resolve(HX_CSTRING("border"));		HX_STACK_VAR(_g21,"_g21");
						HX_STACK_LINE(159)
						return (_g21 != HX_CSTRING("false"));
					}
					return null();
				}
			};
			...
			if (((  ((!((!(child0->has->resolve(HX_CSTRING("border"))))))) ? bool(_Function_2_1::Block(child0)) : bool(true) ))){
				HX_STACK_LINE(160)
				::String _g22 = child0->get_name();		HX_STACK_VAR(_g22,"_g22");
				HX_STACK_LINE(160)
				this->addPadding(_g22,newAttributes);
			}
			HX_STACK_LINE(162)
...
;
	...
	this->setInitialPage();
	HX_STACK_LINE(171)
	this->_slideTimer->addEventListener(::openfl::events::TimerEvent_obj::TIMER,this->slide_dyn());
	HX_STACK_LINE(173)
	this->startMasking();
	HX_STACK_LINE(174)
	this->drawShade();
...
hx::ObjectPtr< UIPages_obj > UIPages_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
::com::danielfreeman::madcomponents::Attributes UIPages_obj::childAttributes( int index){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","childAttributes",0xb00a1641,"com.danielfreeman.madcomponents.UIPages.childAttributes","com/danielfreeman/madcomponents/UIPages.hx",179,0x6e5fd425)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","setVisible",0xe5dab702,"com.danielfreeman.madcomponents.UIPages.setVisible","com/danielfreeman/madcomponents/UIPages.hx",184,0x6e5fd425)
		HX_STACK_THIS(this)
...
Float UIPages_obj::set_drawerHeight( Float value){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","set_drawerHeight",0xa92201c7,"com.danielfreeman.madcomponents.UIPages.set_drawerHeight","com/danielfreeman/madcomponents/UIPages.hx",195,0x6e5fd425)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(196)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","setInitialPage",0xbdd76f83,"com.danielfreeman.madcomponents.UIPages.setInitialPage","com/danielfreeman/madcomponents/UIPages.hx",206,0x6e5fd425)
		HX_STACK_THIS(this)
		HX_STACK_LINE(206)
...
Array< ::Dynamic > UIPages_obj::get_pages( ){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","get_pages",0x64c3d5c9,"com.danielfreeman.madcomponents.UIPages.get_pages","com/danielfreeman/madcomponents/UIPages.hx",218,0x6e5fd425)
	HX_STACK_THIS(this)
	HX_STACK_LINE(218)
	return this->_pages;
}
...
::com::danielfreeman::MadXML UIPages_obj::get_xml( ){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","get_xml",0x0b1bfd1c,"com.danielfreeman.madcomponents.UIPages.get_xml","com/danielfreeman/madcomponents/UIPages.hx",223,0x6e5fd425)
	HX_STACK_THIS(this)
	HX_STACK_LINE(223)
	return this->_xml;
}
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","layout",0x3190d7bc,"com.danielfreeman.madcomponents.UIPages.layout","com/danielfreeman/madcomponents/UIPages.hx",229,0x6e5fd425)
		HX_STACK_THIS(this)
		HX_STACK_ARG(attributes,"attributes")
		HX_STACK_LINE(230)
		...
		HX_STACK_LINE(234)
		::com::danielfreeman::MadXMLList children = this->_xml->children(null());		HX_STACK_VAR(children,"children");
		HX_STACK_LINE(235)
		...
		HX_STACK_LINE(240)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(241)
				::com::danielfreeman::MadXML childXML = children->get(i);		HX_STACK_VAR(childXML,"childXML");
				HX_STACK_LINE(242)
				...
				if (((  (((_g21 != HX_CSTRING("data")))) ? bool(!(childXML->get_nodeKindIsText())) : bool(false) ))){
					...
					struct _Function_4_1{
						inline static bool Block( ::com::danielfreeman::MadXML &childXML){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIPages.hx",246,0x6e5fd425)
							{
								HX_STACK_LINE(246)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","addPadding",0x27de9fc2,"com.danielfreeman.madcomponents.UIPages.addPadding","com/danielfreeman/madcomponents/UIPages.hx",273,0x6e5fd425)
		HX_STACK_THIS(this)
		...
		struct _Function_1_1{
			inline static bool Block( ::String &localName){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIPages.hx",274,0x6e5fd425)
				{
					HX_STACK_LINE(274)
			...
			struct _Function_2_1{
				inline static Dynamic Block( ::String &localName){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/madcomponents/UIPages.hx",274,0x6e5fd425)
					{
						...
						__result->Add(HX_CSTRING("lineNumber") , (int)274,false);
...
::String transition = __o_transition.Default(HX_CSTRING(""));
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","nextPage",0xd4209274,"com.danielfreeman.madcomponents.UIPages.nextPage","com/danielfreeman/madcomponents/UIPages.hx",287,0x6e5fd425)
	HX_STACK_THIS(this)
	HX_STACK_ARG(transition,"transition")
{
		HX_STACK_LINE(287)
		if (((  (((  ((!(this->_slideTimer->get_running()))) ? bool((this->_lastPage == null())) : bool(false) ))) ? bool((this->_page < (this->_pages->length - (int)1))) : bool(false) ))){
			HX_STACK_LINE(288)
...
::String transition = __o_transition.Default(HX_CSTRING(""));
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","previousPage",0xd852ecb8,"com.danielfreeman.madcomponents.UIPages.previousPage","com/danielfreeman/madcomponents/UIPages.hx",302,0x6e5fd425)
	HX_STACK_THIS(this)
	HX_STACK_ARG(transition,"transition")
{
		HX_STACK_LINE(302)
		if (((  (((  ((!(this->_slideTimer->get_running()))) ? bool((this->_lastPage == null())) : bool(false) ))) ? bool((this->_page > (int)0)) : bool(false) ))){
			HX_STACK_LINE(303)
			this->_lastPageIndex = this->_page;
			HX_STACK_LINE(304)
			this->_lastPage = this->_pages->__get(this->_page).StaticCast< ::openfl::display::DisplayObject >();
...
bool alt = __o_alt.Default(false);
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","attachPages",0x1e4a8aed,"com.danielfreeman.madcomponents.UIPages.attachPages","com/danielfreeman/madcomponents/UIPages.hx",316,0x6e5fd425)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","doTransition",0xc5f72792,"com.danielfreeman.madcomponents.UIPages.doTransition","com/danielfreeman/madcomponents/UIPages.hx",327,0x6e5fd425)
		HX_STACK_THIS(this)
		HX_STACK_ARG(transition,"transition")
		HX_STACK_LINE(328)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","drawShade",0xa7f55c37,"com.danielfreeman.madcomponents.UIPages.drawShade","com/danielfreeman/madcomponents/UIPages.hx",378,0x6e5fd425)
		HX_STACK_THIS(this)
		HX_STACK_LINE(379)
...
Float slideY = __o_slideY.Default(0);
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UIPages","startSlide",0x8ab5b781,"com.danielfreeman.madcomponents.UIPages.startSlide","com/danielfreeman/madcomponents/UIPages.hx",390,0x6e5fd425)
	HX_STACK_THIS(this)
...
Void UIPages_obj::slide( ::openfl::events::TimerEvent event){
{
		...
		HX_STACK_LINE(482)
		int _g = this->_slideTimer->get_currentCount();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(482)
		Float t = (Float(_g) / Float(::com::danielfreeman::madcomponents::UIPages_obj::STEPS));		HX_STACK_VAR(t,"t");
		HX_STACK_LINE(483)
		{
			HX_STACK_LINE(483)
			::openfl::display::DisplayObject _g1 = this->_lastPage;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(483)
			Float _g11 = _g1->get_x();		HX_STACK_VAR(_g11,"_g11");
			HX_STACK_LINE(483)
			Float _g2 = this->delta(t,this->_slideX);		HX_STACK_VAR(_g2,"_g2");
			HX_STACK_LINE(483)
			Float _g3;		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(483)
			_g3 = (((  (((bool(this->_over) && bool((this->_slideX < (int)0))))) ? Float(0.2) : Float((  (((bool(this->_over) && bool((this->_slideX > (int)0))))) ? Float(5.) : Float(1.0) )) )) * _g2);
			HX_STACK_LINE(483)
		...
		{
			HX_STACK_LINE(484)
			::openfl::display::DisplayObject _g1 = this->_thisPage;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(484)
			Float _g5 = _g1->get_x();		HX_STACK_VAR(_g5,"_g5");
			HX_STACK_LINE(484)
			Float _g6 = this->delta(t,this->_slideX);		HX_STACK_VAR(_g6,"_g6");
			HX_STACK_LINE(484)
		...
		HX_STACK_LINE(485)
		{
			...
			::openfl::display::DisplayObject _g1 = this->_thisPage;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(485)
			Float _g8 = _g1->get_y();		HX_STACK_VAR(_g8,"_g8");
			HX_STACK_LINE(485)
			Float _g9 = this->delta(t,this->_slideY);		HX_STACK_VAR(_g9,"_g9");
			HX_STACK_LINE(485)
		...
		HX_STACK_LINE(487)
		int _g11 = this->_slideTimer->get_currentCount();		HX_STACK_VAR(_g11,"_g11");
		HX_STACK_LINE(487)
		if (((_g11 == ::com::danielfreeman::madcomponents::UIPages_obj::STEPS))){
			HX_STACK_LINE(488)
			this->slideComplete();
		}
	}
...
Void UIPages_obj::destructor( ){
{
		...
		HX_STACK_LINE(604)
		this->_slideTimer->removeEventListener(::openfl::events::TimerEvent_obj::TIMER,this->slide_dyn());
		HX_STACK_LINE(605)
		{
			HX_STACK_LINE(605)
			int _g = (int)0;		HX_STACK_VAR(_g,"_g");
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::com::danielfreeman::AnimationTimer*/ ,(int)offsetof(UIPages_obj,_slideTimer),HX_CSTRING("_slideTimer")},

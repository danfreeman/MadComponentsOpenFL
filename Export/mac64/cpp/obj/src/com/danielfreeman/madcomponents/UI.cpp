...
::com::danielfreeman::MadXML UI_obj::_xml;
...
::openfl::display::Sprite UI_obj::create( ::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,hx::Null< Float >  __o_width,hx::Null< Float >  __o_height){
	...
	HX_STACK_ARG(height,"height")
{
		...
		if (((::com::danielfreeman::madcomponents::UI_obj::_root == null()))){
			...
			HX_STACK_LINE(146)
			::com::danielfreeman::MadXML _g18 = ::com::danielfreeman::MadXML_obj::parse(_g17);		HX_STACK_VAR(_g18,"_g18");
			HX_STACK_LINE(146)
...
::openfl::display::DisplayObject UI_obj::containers( ::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
...
::openfl::display::Sprite UI_obj::redraw( ){
	...
	HX_STACK_LINE(290)
	::com::danielfreeman::MadXML _g = (hx::TCast< com::danielfreeman::madcomponents::UIForm >::cast(::com::danielfreeman::madcomponents::UI_obj::_root))->get_xml();		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(290)
...
::com::danielfreeman::madcomponents::UIWindow UI_obj::createPopUp( ::com::danielfreeman::MadXML xml,hx::Null< Float >  __o_width,hx::Null< Float >  __o_height,hx::Null< Float >  __o_curve,hx::Null< bool >  __o_centre){
Float width = __o_width.Default(-1);
Float height = __o_height.Default(-1);

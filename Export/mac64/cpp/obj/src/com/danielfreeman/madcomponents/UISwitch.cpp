...
Void UISwitch_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	HX_STACK_LINE(75)
	::com::danielfreeman::AnimationTimer _g = ::com::danielfreeman::AnimationTimer_obj::__new(hx::ObjectPtr<OBJ_>(this),(int)8);		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(75)
	this->_timer = _g;
	HX_STACK_LINE(76)
	if ((xml->has->resolve(HX_CSTRING("onColour")))){
		HX_STACK_LINE(77)
		::String _g1 = xml->att->resolve(HX_CSTRING("onColour"));		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(77)
	...
	if ((xml->has->resolve(HX_CSTRING("offColour")))){
		HX_STACK_LINE(80)
		::String _g3 = xml->att->resolve(HX_CSTRING("offColour"));		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(80)
		int _g4 = ::com::danielfreeman::madcomponents::UI_obj::toColourValue(_g3);		HX_STACK_VAR(_g4,"_g4");
		HX_STACK_LINE(80)
		this->_offColour = _g4;
	}
	HX_STACK_LINE(82)
	if ((xml->has->resolve(HX_CSTRING("outlineColour")))){
		HX_STACK_LINE(83)
		::String _g5 = xml->att->resolve(HX_CSTRING("outlineColour"));		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(83)
		int _g6 = ::com::danielfreeman::madcomponents::UI_obj::toColourValue(_g5);		HX_STACK_VAR(_g6,"_g6");
		HX_STACK_LINE(83)
		this->_outlineColour = _g6;
	}
	HX_STACK_LINE(85)
	if ((xml->has->resolve(HX_CSTRING("shadowColour")))){
		HX_STACK_LINE(86)
		::String _g7 = xml->att->resolve(HX_CSTRING("shadowColour"));		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(86)
		int _g8 = ::com::danielfreeman::madcomponents::UI_obj::toColourValue(_g7);		HX_STACK_VAR(_g8,"_g8");
		HX_STACK_LINE(86)
		this->_shadowColour = _g8;
	}
	HX_STACK_LINE(88)
	if ((xml->has->resolve(HX_CSTRING("sliderColour")))){
		HX_STACK_LINE(89)
		::String _g9 = xml->att->resolve(HX_CSTRING("sliderColour"));		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(89)
		int _g10 = ::com::danielfreeman::madcomponents::UI_obj::toColourValue(_g9);		HX_STACK_VAR(_g10,"_g10");
		HX_STACK_LINE(89)
		this->_sliderColour = _g10;
	}
	HX_STACK_LINE(91)
	...
	if ((xml->has->resolve(HX_CSTRING("state")))){
		HX_STACK_LINE(91)
		::String _g11 = xml->att->resolve(HX_CSTRING("state"));		HX_STACK_VAR(_g11,"_g11");
		HX_STACK_LINE(91)
	...
	HX_STACK_LINE(93)
	this->_timer->addEventListener(::openfl::events::TimerEvent_obj::TIMER,this->animate_dyn());
	HX_STACK_LINE(95)
	this->drawComponent();
}
;
...
hx::ObjectPtr< UISwitch_obj > UISwitch_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","animate",0xbc83a14f,"com.danielfreeman.madcomponents.UISwitch.animate","com/danielfreeman/madcomponents/UISwitch.hx",99,0xcaea34bf)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(100)
		::com::danielfreeman::AnimationTimer timer = this->_timer;		HX_STACK_VAR(timer,"timer");
		HX_STACK_LINE(101)
		int _g = timer->get_currentCount();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(101)
		int _g1 = (_g + (int)1);		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(101)
		Float factor = (Float(_g1) / Float((int)8));		HX_STACK_VAR(factor,"factor");
		HX_STACK_LINE(102)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","mouseDown",0x413aff55,"com.danielfreeman.madcomponents.UISwitch.mouseDown","com/danielfreeman/madcomponents/UISwitch.hx",107,0xcaea34bf)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(108)
		this->_ready = true;
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","mouseUp",0x02a9ba8e,"com.danielfreeman.madcomponents.UISwitch.mouseUp","com/danielfreeman/madcomponents/UISwitch.hx",119,0xcaea34bf)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(119)
		if ((this->_ready)){
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","mouseMove",0x472dea04,"com.danielfreeman.madcomponents.UISwitch.mouseMove","com/danielfreeman/madcomponents/UISwitch.hx",138,0xcaea34bf)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(139)
...
int UISwitch_obj::interpolate( int colourA,int colourB,Float factor){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","interpolate",0x3afd8a6f,"com.danielfreeman.madcomponents.UISwitch.interpolate","com/danielfreeman/madcomponents/UISwitch.hx",149,0xcaea34bf)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","drawSwitch",0xde08df2a,"com.danielfreeman.madcomponents.UISwitch.drawSwitch","com/danielfreeman/madcomponents/UISwitch.hx",156,0xcaea34bf)
		HX_STACK_THIS(this)
...
bool UISwitch_obj::get_state( ){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","get_state",0x1a2d2096,"com.danielfreeman.madcomponents.UISwitch.get_state","com/danielfreeman/madcomponents/UISwitch.hx",188,0xcaea34bf)
	HX_STACK_THIS(this)
	HX_STACK_LINE(188)
	return this->_state;
}
...
bool UISwitch_obj::set_state( bool value){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","set_state",0xfd7e0ca2,"com.danielfreeman.madcomponents.UISwitch.set_state","com/danielfreeman/madcomponents/UISwitch.hx",192,0xcaea34bf)
	HX_STACK_THIS(this)
...
::String UISwitch_obj::set_text( ::String value){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","set_text",0x28c8f33c,"com.danielfreeman.madcomponents.UISwitch.set_text","com/danielfreeman/madcomponents/UISwitch.hx",201,0xcaea34bf)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(202)
...
::String UISwitch_obj::get_text( ){
	HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","get_text",0x7a6b99c8,"com.danielfreeman.madcomponents.UISwitch.get_text","com/danielfreeman/madcomponents/UISwitch.hx",210,0xcaea34bf)
	HX_STACK_THIS(this)
	HX_STACK_LINE(210)
	if ((this->_state)){
		HX_STACK_LINE(210)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","drawComponent",0x1aa10147,"com.danielfreeman.madcomponents.UISwitch.drawComponent","com/danielfreeman/madcomponents/UISwitch.hx",215,0xcaea34bf)
		HX_STACK_THIS(this)
		HX_STACK_LINE(215)
...
{
		HX_STACK_FRAME("com.danielfreeman.madcomponents.UISwitch","destructor",0xeaddf54b,"com.danielfreeman.madcomponents.UISwitch.destructor","com/danielfreeman/madcomponents/UISwitch.hx",219,0xcaea34bf)
		HX_STACK_THIS(this)
		HX_STACK_LINE(220)
		...
		this->get_stage()->removeEventListener(::openfl::events::MouseEvent_obj::MOUSE_MOVE,this->mouseMove_dyn(),null());
		HX_STACK_LINE(224)
		this->_timer->removeEventListener(::openfl::events::TimerEvent_obj::TIMER,this->animate_dyn());
	}
return null();
}
...
Dynamic UISwitch_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 6:
		...
		if (HX_FIELD_EQ(inName,"_timer") ) { _timer=inValue.Cast< ::com::danielfreeman::AnimationTimer >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::com::danielfreeman::AnimationTimer*/ ,(int)offsetof(UISwitch_obj,_timer),HX_CSTRING("_timer")},

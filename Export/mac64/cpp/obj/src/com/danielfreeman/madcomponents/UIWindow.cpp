...
Void UIWindow_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< Float >  __o_curve,hx::Null< bool >  __o_centre)
{
...
hx::ObjectPtr< UIWindow_obj > UIWindow_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< Float >  __o_curve,hx::Null< bool >  __o_centre)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::com::danielfreeman::MadXML*/ ,(int)offsetof(UIWindow_obj,_xml),HX_CSTRING("_xml")},
	{ hx::fsUnknown, 0, null()}
};
#endif

...
Void UINavigationPages_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UINavigationPages_obj > UINavigationPages_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
bool UINavigationPages_obj::backChain( ){
	...
	if ((!(((  ((::Std_obj::is(pageContents,hx::ClassOf< ::com::danielfreeman::madcomponents::UINavigationPages >()))) ? bool((hx::TCast< com::danielfreeman::madcomponents::UINavigationPages >::cast(pageContents))->backChain()) : bool(false) ))))){
		HX_STACK_LINE(85)
		if (((  (((  ((!(this->_slideTimer->get_running()))) ? bool(this->_autoBack) : bool(false) ))) ? bool((this->_page > (int)0)) : bool(false) ))){
			HX_STACK_LINE(86)

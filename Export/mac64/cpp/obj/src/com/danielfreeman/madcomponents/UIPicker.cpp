...
Void UIPicker_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_left,hx::Null< bool >  __o_right,hx::Null< Float >  __o_pickerHeight,hx::Null< Float >  __o_cursorHeight)
{
...
hx::ObjectPtr< UIPicker_obj > UIPicker_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_left,hx::Null< bool >  __o_right,hx::Null< Float >  __o_pickerHeight,hx::Null< Float >  __o_cursorHeight)

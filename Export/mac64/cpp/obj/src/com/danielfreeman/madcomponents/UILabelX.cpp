...
Void UILabelX_obj::__construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UILabelX_obj > UILabelX_obj::__new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UILabelX_obj::assignToLabel( ::com::danielfreeman::MadXML xml){
{
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::com::danielfreeman::MadXML*/ ,(int)offsetof(UILabelX_obj,_xml),HX_CSTRING("_xml")},

...
{
		HX_STACK_FRAME("haxe.io.Output","writeByte",0xb4fe513a,"haxe.io.Output.writeByte","/usr/lib/haxe/std/haxe/io/Output.hx",39,0xbdd9ff1c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(c,"c")
		HX_STACK_LINE(39)
...
int Output_obj::writeBytes( ::haxe::io::Bytes s,int pos,int len){
	HX_STACK_FRAME("haxe.io.Output","writeBytes",0xa988c1f9,"haxe.io.Output.writeBytes","/usr/lib/haxe/std/haxe/io/Output.hx",42,0xbdd9ff1c)
	HX_STACK_THIS(this)
	HX_STACK_ARG(s,"s")
...
{
		HX_STACK_FRAME("haxe.io.Output","write",0x6f1d1512,"haxe.io.Output.write","/usr/lib/haxe/std/haxe/io/Output.hx",78,0xbdd9ff1c)
		HX_STACK_THIS(this)
		HX_STACK_ARG(s,"s")
		HX_STACK_LINE(79)

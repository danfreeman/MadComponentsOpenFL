...
{
HX_STACK_FRAME("Main","new",0x6616a5cb,"Main.new","Main.hx",520,0x087e5c05)
HX_STACK_THIS(this)
...
static void sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(Main_obj::SCROLL,"SCROLL");
...
static void sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(Main_obj::SCROLL,"SCROLL");
...
void Main_obj::__boot()
{
	...
	SCROLL= HX_CSTRING("<scrollVertical>\n\t\t\t<button/>\n\t\t\t<button/>\n\t\t\t<button/>\n\t\t</scrollVertical>");

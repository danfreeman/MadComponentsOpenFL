...
{
HX_STACK_FRAME("_MadXML.AttribAccess","new",0x5d407b28,"_MadXML.AttribAccess.new","MadXML.hx",29,0x14be1bd7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(29)
...
::String AttribAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("_MadXML.AttribAccess","resolve",0xf10dc1b4,"_MadXML.AttribAccess.resolve","MadXML.hx",32,0x14be1bd7)
	HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("_MadXML.AttribAccess"), hx::TCanCast< AttribAccess_obj> ,sStaticFields,sMemberFields,

...
{
HX_STACK_FRAME("_MadXML.HasNodeAccess","new",0xa51a568a,"_MadXML.HasNodeAccess.new","MadXML.hx",64,0x14be1bd7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(64)
...
bool HasNodeAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("_MadXML.HasNodeAccess","resolve",0xc7b5f616,"_MadXML.HasNodeAccess.resolve","MadXML.hx",68,0x14be1bd7)
	HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("_MadXML.HasNodeAccess"), hx::TCanCast< HasNodeAccess_obj> ,sStaticFields,sMemberFields,

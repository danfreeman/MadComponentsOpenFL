...
{
HX_STACK_FRAME("_MadXML.NodeAccess","new",0xff72b9e0,"_MadXML.NodeAccess.new","MadXML.hx",10,0x14be1bd7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(10)
...
::MadXML NodeAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("_MadXML.NodeAccess","resolve",0x5df1bc6c,"_MadXML.NodeAccess.resolve","MadXML.hx",13,0x14be1bd7)
	HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("_MadXML.NodeAccess"), hx::TCanCast< NodeAccess_obj> ,sStaticFields,sMemberFields,

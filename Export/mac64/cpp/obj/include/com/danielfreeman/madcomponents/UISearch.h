...
class HXCPP_CLASS_ATTRIBUTES  UISearch_obj : public ::com::danielfreeman::madcomponents::UIInput_obj{
	...
	public:
		...
		static hx::ObjectPtr< UISearch_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

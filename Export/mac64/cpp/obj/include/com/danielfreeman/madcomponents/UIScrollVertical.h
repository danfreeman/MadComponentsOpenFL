...
class HXCPP_CLASS_ATTRIBUTES  UIScrollVertical_obj : public ::com::danielfreeman::madcomponents::MadMasking_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIScrollVertical_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		::com::danielfreeman::AnimationTimer _touchTimer;
		::com::danielfreeman::AnimationTimer _moveTimer;
		::com::danielfreeman::AnimationTimer _dragTimer;

...
class HXCPP_CLASS_ATTRIBUTES  UIGroupedList_obj : public ::com::danielfreeman::madcomponents::UIList_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIGroupedList_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

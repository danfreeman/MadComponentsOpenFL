...
#define INCLUDED_com_danielfreeman_madcomponents_UISliderX
...
HX_DECLARE_CLASS3(com,danielfreeman,madcomponents,UISliderX)
...
class HXCPP_CLASS_ATTRIBUTES  UISliderX_obj : public ::com::danielfreeman::madcomponents::UISlider_obj{
	public:
		typedef ::com::danielfreeman::madcomponents::UISlider_obj super;
		typedef UISliderX_obj OBJ_;
		UISliderX_obj();
	...
	public:
		...
		static hx::ObjectPtr< UISliderX_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		inline operator ::com::danielfreeman::madcomponents::IComponentUI_obj *()
			{ return new ::com::danielfreeman::madcomponents::IComponentUI_delegate_< UISliderX_obj >(this); }
		hx::Object *__ToInterface(const hx::type_info &inType);
		::String __ToString() const { return HX_CSTRING("UISliderX"); }
...
#endif /* INCLUDED_com_danielfreeman_madcomponents_UISliderX */ 

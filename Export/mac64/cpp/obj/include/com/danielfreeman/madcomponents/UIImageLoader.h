...
class HXCPP_CLASS_ATTRIBUTES  UIImageLoader_obj : public ::com::danielfreeman::madcomponents::UIImage_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIImageLoader_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

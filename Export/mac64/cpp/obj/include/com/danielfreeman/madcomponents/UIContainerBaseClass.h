...
class HXCPP_CLASS_ATTRIBUTES  UIContainerBaseClass_obj : public ::com::danielfreeman::madcomponents::MadSprite_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIContainerBaseClass_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		virtual Void initialise( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

...
class HXCPP_CLASS_ATTRIBUTES  UIDividedList_obj : public ::com::danielfreeman::madcomponents::UIGroupedList_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIDividedList_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

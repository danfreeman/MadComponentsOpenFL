...
class HXCPP_CLASS_ATTRIBUTES  UIRenderer_obj : public ::com::danielfreeman::madcomponents::UIContainerBaseClass_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIRenderer_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

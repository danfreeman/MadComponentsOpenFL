...
class HXCPP_CLASS_ATTRIBUTES  UIForm_obj : public ::com::danielfreeman::madcomponents::MadMasking_obj{
	public:
		...
		UIForm_obj();
		Void __construct(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_row,hx::Null< bool >  __o_inGroup);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< UIForm_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_row,hx::Null< bool >  __o_inGroup);
		...
		virtual ::com::danielfreeman::MadXML set_xml( ::com::danielfreeman::MadXML value);
		Dynamic set_xml_dyn();
		...
		virtual Void widthAndHeight( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		Dynamic widthAndHeight_dyn();

		virtual bool set_isVisible( bool value);

		virtual Void parseBlock( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,::String mode,bool row);
		...
		virtual int numberOfColumns( ::com::danielfreeman::MadXMLList xmlList);
		...
		virtual ::openfl::display::DisplayObject otherCommands( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

...
class HXCPP_CLASS_ATTRIBUTES  Attributes_obj : public ::openfl::geom::Rectangle_obj{
	...
	public:
		...
		::String _clickable;
		bool _style7;
		virtual Void parse( ::com::danielfreeman::MadXML xml);
		Dynamic parse_dyn();

		virtual ::com::danielfreeman::madcomponents::Attributes copy( ::com::danielfreeman::MadXML xml,hx::Null< bool >  container);
		Dynamic copy_dyn();

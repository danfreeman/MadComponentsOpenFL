...
class HXCPP_CLASS_ATTRIBUTES  UINavigationBar_obj : public ::openfl::display::Sprite_obj{
	...
	public:
		...
		static hx::ObjectPtr< UINavigationBar_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

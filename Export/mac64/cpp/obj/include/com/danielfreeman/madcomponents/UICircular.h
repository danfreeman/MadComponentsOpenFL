...
class HXCPP_CLASS_ATTRIBUTES  UICircular_obj : public ::com::danielfreeman::madcomponents::UIContainerBaseClass_obj{
	...
	public:
		...
		static hx::ObjectPtr< UICircular_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

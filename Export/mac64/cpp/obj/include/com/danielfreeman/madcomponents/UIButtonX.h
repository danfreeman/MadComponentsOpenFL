...
class HXCPP_CLASS_ATTRIBUTES  UIButtonX_obj : public ::com::danielfreeman::madcomponents::UIButton_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIButtonX_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

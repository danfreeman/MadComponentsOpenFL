...
class HXCPP_CLASS_ATTRIBUTES  Model_obj : public ::openfl::net::URLLoader_obj{
	public:
		...
		Model_obj();
		Void __construct(::openfl::display::Sprite parent,::com::danielfreeman::MadXML xml,::com::danielfreeman::MadXML sendXml);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< Model_obj > __new(::openfl::display::Sprite parent,::com::danielfreeman::MadXML xml,::com::danielfreeman::MadXML sendXml);
		...
		::com::danielfreeman::MadXML _schema;
		::com::danielfreeman::MadXML _sendSchema;
		...
		virtual Dynamic parseAMFlist( Dynamic record,::com::danielfreeman::MadXML schema,Dynamic result,::String path);
		...
		virtual ::com::danielfreeman::MadXML set_dataXML( ::com::danielfreeman::MadXML xml);
		Dynamic set_dataXML_dyn();

		virtual Dynamic get_dataAMF( );
		Dynamic get_dataAMF_dyn();

		virtual Dynamic listData( ::com::danielfreeman::MadXML xml,::com::danielfreeman::MadXML schema);
		Dynamic listData_dyn();

		virtual Void attributeValues( ::com::danielfreeman::MadXML item,::com::danielfreeman::MadXML childSchema,Dynamic result);
		Dynamic attributeValues_dyn();

		virtual Dynamic listValues( ::com::danielfreeman::MadXML item,::com::danielfreeman::MadXML childSchema);
		Dynamic listValues_dyn();

		virtual Dynamic listObject( ::com::danielfreeman::MadXML item,::com::danielfreeman::MadXMLList childSchema,Dynamic result);
		Dynamic listObject_dyn();

		virtual Dynamic xmlToObject( ::com::danielfreeman::MadXML xml);
		Dynamic xmlToObject_dyn();

		virtual ::com::danielfreeman::MadXML xmlPath( ::com::danielfreeman::MadXML xml,::String path);
		Dynamic xmlPath_dyn();

		virtual Dynamic sendData( ::String sendBy);
		Dynamic sendData_dyn();

		virtual Void substitute( ::com::danielfreeman::MadXML data);

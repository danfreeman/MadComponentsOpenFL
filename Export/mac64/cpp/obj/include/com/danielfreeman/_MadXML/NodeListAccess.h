...
#define INCLUDED_com_danielfreeman__MadXML_NodeListAccess
...
class HXCPP_CLASS_ATTRIBUTES  NodeListAccess_obj : public hx::Object{
	...
	public:
		...
		::Xml __x;
		virtual ::com::danielfreeman::MadXMLList resolve( ::String name);
		Dynamic resolve_dyn();
...
#endif /* INCLUDED_com_danielfreeman__MadXML_NodeListAccess */ 

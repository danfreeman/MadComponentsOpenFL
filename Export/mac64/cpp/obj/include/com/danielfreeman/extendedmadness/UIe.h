...
class HXCPP_CLASS_ATTRIBUTES  UIe_obj : public ::com::danielfreeman::madcomponents::UI_obj{
	...
	public:
		...
		static ::openfl::display::Sprite createInWindow( ::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml);
		...
		static ::openfl::text::TextFormat toTextFormat( ::com::danielfreeman::MadXML formatXML,::openfl::text::TextFormat format);

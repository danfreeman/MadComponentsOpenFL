...
class HXCPP_CLASS_ATTRIBUTES  UIRadioButton_obj : public ::com::danielfreeman::extendedmadness::UICheckBox_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIRadioButton_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

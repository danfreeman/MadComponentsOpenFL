...
class HXCPP_CLASS_ATTRIBUTES  UIStarRating_obj : public ::com::danielfreeman::madcomponents::MadSprite_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIStarRating_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

...
class HXCPP_CLASS_ATTRIBUTES  UISegmentedControl_obj : public ::com::danielfreeman::extendedmadness::UICutCopyPaste_obj{
	...
	public:
		...
		static hx::ObjectPtr< UISegmentedControl_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		virtual Array< ::String > extractData( ::com::danielfreeman::MadXML xml);

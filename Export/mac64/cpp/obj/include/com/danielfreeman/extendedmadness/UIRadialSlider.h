...
class HXCPP_CLASS_ATTRIBUTES  UIRadialSlider_obj : public ::com::danielfreeman::madcomponents::MadSprite_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIRadialSlider_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		virtual Void extractParameters( ::com::danielfreeman::MadXML xml);

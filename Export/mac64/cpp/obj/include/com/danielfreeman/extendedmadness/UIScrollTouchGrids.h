...
class HXCPP_CLASS_ATTRIBUTES  UIScrollTouchGrids_obj : public ::com::danielfreeman::extendedmadness::UIScrollDataGrids_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIScrollTouchGrids_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		::com::danielfreeman::AnimationTimer _slideTimer;

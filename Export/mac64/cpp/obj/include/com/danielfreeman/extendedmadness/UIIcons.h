...
class HXCPP_CLASS_ATTRIBUTES  UIIcons_obj : public ::com::danielfreeman::madcomponents::MadSprite_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIIcons_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		Float _scaleHeight;
		::String _text;
		virtual ::com::danielfreeman::MadXML doDeletes( ::com::danielfreeman::MadXML xml);
		Dynamic doDeletes_dyn();

		virtual Void extractData( ::com::danielfreeman::MadXML xml);
		Dynamic extractData_dyn();

		virtual ::String imageAttributeText( ::com::danielfreeman::MadXML item);

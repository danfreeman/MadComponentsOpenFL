...
class HXCPP_CLASS_ATTRIBUTES  UIPanel_obj : public ::com::danielfreeman::madcomponents::UIForm_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIPanel_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_row,hx::Null< bool >  __o_inGroup);

...
class HXCPP_CLASS_ATTRIBUTES  UITabPagesTop_obj : public ::com::danielfreeman::madcomponents::UITabPages_obj{
	...
	public:
		...
		static hx::ObjectPtr< UITabPagesTop_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

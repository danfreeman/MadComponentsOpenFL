...
class HXCPP_CLASS_ATTRIBUTES  UIScrollDataGrids_obj : public ::com::danielfreeman::extendedmadness::UIScrollDataGrid_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIScrollDataGrids_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		virtual Void initialiseLayers( ::com::danielfreeman::MadXML xml);

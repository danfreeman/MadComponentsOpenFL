...
class HXCPP_CLASS_ATTRIBUTES  UIFastDataGrid_obj : public ::com::danielfreeman::extendedmadness::UISimpleDataGrid_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIFastDataGrid_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

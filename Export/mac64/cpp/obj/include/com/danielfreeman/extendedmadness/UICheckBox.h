...
class HXCPP_CLASS_ATTRIBUTES  UICheckBox_obj : public ::com::danielfreeman::madcomponents::MadSprite_obj{
	...
	public:
		...
		static hx::ObjectPtr< UICheckBox_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		bool _ready;
		virtual Void assignToLabel( ::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::UILabel label);

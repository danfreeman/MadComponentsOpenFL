...
class HXCPP_CLASS_ATTRIBUTES  UIScrollHorizontal_obj : public ::com::danielfreeman::madcomponents::UIScrollVertical_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIScrollHorizontal_obj > __new(::openfl::display::Sprite screen,::com::danielfreeman::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);

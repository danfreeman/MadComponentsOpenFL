...
{
HX_STACK_FRAME("_MadXML.HasAttribAccess","new",0x71881652,"_MadXML.HasAttribAccess.new","MadXML.hx",48,0x14be1bd7)
HX_STACK_THIS(this)
HX_STACK_ARG(x,"x")
{
	HX_STACK_LINE(48)
...
bool HasAttribAccess_obj::resolve( ::String name){
	HX_STACK_FRAME("_MadXML.HasAttribAccess","resolve",0x7f9339de,"_MadXML.HasAttribAccess.resolve","MadXML.hx",51,0x14be1bd7)
	HX_STACK_THIS(this)
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("_MadXML.HasAttribAccess"), hx::TCanCast< HasAttribAccess_obj> ,sStaticFields,sMemberFields,

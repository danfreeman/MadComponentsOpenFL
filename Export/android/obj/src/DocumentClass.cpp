...
Void DocumentClass_obj::__construct(::openfl::display::Sprite screen)
{
...
hx::ObjectPtr< DocumentClass_obj > DocumentClass_obj::__new(::openfl::display::Sprite screen)

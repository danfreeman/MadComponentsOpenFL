...
::MadXMLList_obj::__register();
::MadXML_obj::__register();
::_MadXML::NodeListAccess_obj::__register();
::_MadXML::HasNodeAccess_obj::__register();
::_MadXML::HasAttribAccess_obj::__register();
::_MadXML::AttribAccess_obj::__register();
::_MadXML::NodeAccess_obj::__register();
::List_obj::__register();
...
::Lambda_obj::__boot();
::List_obj::__boot();
::_MadXML::NodeAccess_obj::__boot();
::_MadXML::AttribAccess_obj::__boot();
::_MadXML::HasAttribAccess_obj::__boot();
::_MadXML::HasNodeAccess_obj::__boot();
::_MadXML::NodeListAccess_obj::__boot();
::MadXML_obj::__boot();
::MadXMLList_obj::__boot();

...
Void UIScreens_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UIScreens_obj > UIScreens_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
int UIScreens_obj::whichScreenIndex( ){
	...
	HX_STACK_LINE(62)
	for(::cpp::FastIterator_obj< ::MadXML > *__it = ::cpp::CreateFastIterator< ::MadXML >(this->_xml->children(null())->iterator());  __it->hasNext(); ){
		::MadXML child = __it->next();
		{
			struct _Function_2_1{
				inline static bool Block( ::MadXML &child,hx::ObjectPtr< ::com::danielfreeman::extendedmadness::UIScreens_obj > __this){

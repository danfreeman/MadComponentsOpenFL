...
Void UITabPagesTop_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UITabPagesTop_obj > UITabPagesTop_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UITabPagesTop_obj::initialiseButtonBar( ::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{

...
Void UIProgressBar_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UIProgressBar_obj > UIProgressBar_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::MadXML*/ ,(int)offsetof(UIProgressBar_obj,_xml),HX_CSTRING("_xml")},
	{ hx::fsUnknown, 0, null()}
};
#endif

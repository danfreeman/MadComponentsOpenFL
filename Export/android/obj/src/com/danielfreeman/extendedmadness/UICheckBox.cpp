...
Void UICheckBox_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UICheckBox_obj > UICheckBox_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UICheckBox_obj::assignToLabel( ::MadXML xml,::com::danielfreeman::madcomponents::UILabel label){
{

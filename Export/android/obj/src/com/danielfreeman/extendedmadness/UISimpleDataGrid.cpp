...
Void UISimpleDataGrid_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	if ((xml->hasNode->resolve(HX_CSTRING("font")))){
		HX_STACK_LINE(148)
		::MadXML _g7 = xml->node->resolve(HX_CSTRING("font"));		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(148)
	...
	if ((xml->hasNode->resolve(HX_CSTRING("headerFont")))){
		HX_STACK_LINE(151)
		::MadXML _g9 = xml->node->resolve(HX_CSTRING("headerFont"));		HX_STACK_VAR(_g9,"_g9");
		HX_STACK_LINE(151)
	...
	if ((xml->hasNode->resolve(HX_CSTRING("titleFont")))){
		HX_STACK_LINE(154)
		::MadXML _g11 = xml->node->resolve(HX_CSTRING("titleFont"));		HX_STACK_VAR(_g11,"_g11");
		HX_STACK_LINE(154)
	...
	if ((xml->hasNode->resolve(HX_CSTRING("data")))){
		HX_STACK_LINE(200)
		::MadXML _g27 = xml->node->resolve(HX_CSTRING("data"));		HX_STACK_VAR(_g27,"_g27");
		HX_STACK_LINE(200)
...
hx::ObjectPtr< UISimpleDataGrid_obj > UISimpleDataGrid_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
::String UISimpleDataGrid_obj::set_title( ::String value){
	...
	HX_STACK_LINE(271)
	if ((::MadXML_obj::parse(((HX_CSTRING("<a>") + value) + HX_CSTRING("</a>")))->get_hasChildren())){
		HX_STACK_LINE(272)
...
Void UISimpleDataGrid_obj::extractData( ::MadXML xml){
{
		...
		HX_STACK_ARG(xml,"xml")
		HX_STACK_LINE(444)
		::MadXMLList rows = xml->nodes->resolve(HX_CSTRING("row"));		HX_STACK_VAR(rows,"rows");
		HX_STACK_LINE(445)
		Dynamic _g = Dynamic( Array_obj<Dynamic>::__new() );		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(445)
		this->_data = _g;
		HX_STACK_LINE(446)
		for(::cpp::FastIterator_obj< ::MadXML > *__it = ::cpp::CreateFastIterator< ::MadXML >(rows->iterator());  __it->hasNext(); ){
			::MadXML row = __it->next();
			{
				HX_STACK_LINE(447)
...
Array< ::String > UISimpleDataGrid_obj::extractHeader( ::MadXML xml){

...
Void UIScrollDataGrid_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	HX_STACK_LINE(107)
	this->_columnSlideTimer = ::openfl::utils::Timer_obj::__new((int)50,(int)4);
	HX_STACK_LINE(106)
	...
	HX_STACK_LINE(125)
	::MadXML _g5 = this->noChildren(xml);		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(125)
	...
	struct _Function_1_2{
		inline static bool Block( ::MadXML &xml){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",127,0x0cd2a07e)
			{
				HX_STACK_LINE(127)
				::String _g6 = xml->att->resolve(HX_CSTRING("slideFixedColumns"));		HX_STACK_VAR(_g6,"_g6");
				HX_STACK_LINE(127)
				return (_g6 == HX_CSTRING("true"));
			}
			return null();
		}
	};
	...
	if (((  ((xml->has->resolve(HX_CSTRING("slideFixedColumns")))) ? bool(_Function_1_2::Block(xml)) : bool(false) ))){
		...
		HX_STACK_LINE(129)
		this->_columnSlideTimer->addEventListener(::openfl::events::TimerEvent_obj::TIMER,this->columnSlideMovement_dyn(),null(),null(),null());
	}
	HX_STACK_LINE(131)
...
hx::ObjectPtr< UIScrollDataGrid_obj > UIScrollDataGrid_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","slideFixedColumnsIn",0x83e3d4ae,"com.danielfreeman.extendedmadness.UIScrollDataGrid.slideFixedColumnsIn","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",138,0x0cd2a07e)
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::extendedmadness::UIScrollDataGrid_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",138,0x0cd2a07e)
				{
					HX_STACK_LINE(138)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","slideFixedColumnsOut",0xe37ad7a5,"com.danielfreeman.extendedmadness.UIScrollDataGrid.slideFixedColumnsOut","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",153,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(154)
		this->_columnSlideTimer->stop();
		HX_STACK_LINE(155)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","columnSlideMovement",0xe2c48459,"com.danielfreeman.extendedmadness.UIScrollDataGrid.columnSlideMovement","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",165,0x0cd2a07e)
		HX_STACK_THIS(this)
...
::MadXML UIScrollDataGrid_obj::noChildren( ::MadXML xml){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","noChildren",0xb256daf1,"com.danielfreeman.extendedmadness.UIScrollDataGrid.noChildren","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",173,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(xml,"xml")
	HX_STACK_LINE(174)
	...
	HX_STACK_LINE(182)
	return ::MadXML_obj::parse(result);
}
...
bool flag = __o_flag.Default(false);
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","colourFixedColumns",0xca1d3d86,"com.danielfreeman.extendedmadness.UIScrollDataGrid.colourFixedColumns","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",189,0x0cd2a07e)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","sliceTable",0x3b7576ad,"com.danielfreeman.extendedmadness.UIScrollDataGrid.sliceTable","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",213,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(dataGrid,"dataGrid")
		HX_STACK_LINE(214)
...
Void UIScrollDataGrid_obj::createSlider( ::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","createSlider",0xa2dd78ce,"com.danielfreeman.extendedmadness.UIScrollDataGrid.createSlider","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",250,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(xml,"xml")
		HX_STACK_ARG(attributes,"attributes")
		HX_STACK_LINE(251)
		...
		struct _Function_1_1{
			inline static bool Block( ::MadXML &xml){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",252,0x0cd2a07e)
				{
					HX_STACK_LINE(252)
		...
		if (((  ((xml->has->resolve(HX_CSTRING("datagrid")))) ? bool(_Function_1_1::Block(xml)) : bool(false) ))){
			...
			struct _Function_2_1{
				inline static bool Block( ::MadXML &xml){
					HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",255,0x0cd2a07e)
					{
						HX_STACK_LINE(255)
...
Float UIScrollDataGrid_obj::set_sliderX( Float value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_sliderX",0x301dc8c9,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_sliderX","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",267,0x0cd2a07e)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","mouseMove",0x9b8854a5,"com.danielfreeman.extendedmadness.UIScrollDataGrid.mouseMove","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",290,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		struct _Function_1_1{
			inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::extendedmadness::UIScrollDataGrid_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",291,0x0cd2a07e)
				{
					HX_STACK_LINE(291)
...
bool show = __o_show.Default(true);
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","pressButton",0xb586f864,"com.danielfreeman.extendedmadness.UIScrollDataGrid.pressButton","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",308,0x0cd2a07e)
	HX_STACK_THIS(this)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","doSearchHit",0x53d7794f,"com.danielfreeman.extendedmadness.UIScrollDataGrid.doSearchHit","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",312,0x0cd2a07e)
		HX_STACK_THIS(this)
	}
return null();
}
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","mouseDrag",0x95979d88,"com.danielfreeman.extendedmadness.UIScrollDataGrid.mouseDrag","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",317,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
	}
return null();
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","mouseDown",0x959569f6,"com.danielfreeman.extendedmadness.UIScrollDataGrid.mouseDown","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",322,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(event,"event")
		HX_STACK_LINE(323)
		Float _g = this->_slider->get_x();		HX_STACK_VAR(_g,"_g");
...
Float UIScrollDataGrid_obj::getSliderWidth( ){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","getSliderWidth",0x9014d400,"com.danielfreeman.extendedmadness.UIScrollDataGrid.getSliderWidth","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",329,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(329)
...
Float UIScrollDataGrid_obj::getSliderHeight( ){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","getSliderHeight",0x387424ad,"com.danielfreeman.extendedmadness.UIScrollDataGrid.getSliderHeight","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",334,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(334)
...
Float UIScrollDataGrid_obj::set_sliderY( Float value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_sliderY",0x301dc8ca,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_sliderY","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",338,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(339)
	...
	struct _Function_1_1{
		inline static Dynamic Block( Dynamic &_g3){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",339,0x0cd2a07e)
			{
				hx::Anon __result = hx::Anon_obj::Create();
				__result->Add(HX_CSTRING("fileName") , HX_CSTRING("UIScrollDataGrid.hx"),false);
				__result->Add(HX_CSTRING("lineNumber") , (int)339,false);
...
Dynamic UIScrollDataGrid_obj::set_gridData( Dynamic value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_gridData",0x1f387e1e,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_gridData","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",355,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(356)
...
Dynamic UIScrollDataGrid_obj::set_headerAndData( Dynamic value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_headerAndData",0x3cabd1c6,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_headerAndData","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",365,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(366)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","clear",0x9fefd6dc,"com.danielfreeman.extendedmadness.UIScrollDataGrid.clear","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",381,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(381)
...
int UIScrollDataGrid_obj::set_fixedColumns( int value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_fixedColumns",0x16251ad7,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_fixedColumns","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",387,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(388)
...
bool padding = __o_padding.Default(false);
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","compact",0x34dca2b2,"com.danielfreeman.extendedmadness.UIScrollDataGrid.compact","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",406,0x0cd2a07e)
	HX_STACK_THIS(this)
...
Array< ::Dynamic > UIScrollDataGrid_obj::get_tableCells( ){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","get_tableCells",0xfcb592bd,"com.danielfreeman.extendedmadness.UIScrollDataGrid.get_tableCells","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",411,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(411)
...
bool UIScrollDataGrid_obj::get_hasHeader( ){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","get_hasHeader",0x61cd5cad,"com.danielfreeman.extendedmadness.UIScrollDataGrid.get_hasHeader","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",416,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(416)
...
::MadXML UIScrollDataGrid_obj::get_xml( ){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","get_xml",0xd843cd7d,"com.danielfreeman.extendedmadness.UIScrollDataGrid.get_xml","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",421,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(421)
...
Float UIScrollDataGrid_obj::set_textSize( Float value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_textSize",0x29e53e1c,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_textSize","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",425,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(426)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","fixedHeaderLine",0x3d792cc4,"com.danielfreeman.extendedmadness.UIScrollDataGrid.fixedHeaderLine","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",433,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(dataGrid,"dataGrid")
		HX_STACK_LINE(434)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","autoScrollEnabled",0xa877f6d4,"com.danielfreeman.extendedmadness.UIScrollDataGrid.autoScrollEnabled","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",465,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(465)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","layout",0xa2fcee7b,"com.danielfreeman.extendedmadness.UIScrollDataGrid.layout","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",473,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_ARG(attributes,"attributes")
		HX_STACK_LINE(474)
...
int group = __o_group.Default(-1);
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","findViewById",0x7c464e81,"com.danielfreeman.extendedmadness.UIScrollDataGrid.findViewById","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",491,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(id,"id")
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","showScrollBar",0x909b2758,"com.danielfreeman.extendedmadness.UIScrollDataGrid.showScrollBar","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",495,0x0cd2a07e)
		HX_STACK_THIS(this)
		struct _Function_1_1{
			inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::extendedmadness::UIScrollDataGrid_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",496,0x0cd2a07e)
				{
					HX_STACK_LINE(496)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","hideScrollBar",0xc44a26f3,"com.danielfreeman.extendedmadness.UIScrollDataGrid.hideScrollBar","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",503,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(504)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","adjustMaximumSlide",0xf5db61b1,"com.danielfreeman.extendedmadness.UIScrollDataGrid.adjustMaximumSlide","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",511,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(512)
...
bool UIScrollDataGrid_obj::set_slideFixedColumns( bool value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_slideFixedColumns",0xff2e4ccc,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_slideFixedColumns","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",521,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(522)
...
::String UIScrollDataGrid_obj::set_title( ::String value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_title",0xde0816ca,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_title","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",529,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(530)
...
Array< int > UIScrollDataGrid_obj::set_colours( Array< int > value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_colours",0x8b5dac59,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_colours","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",537,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(538)
...
Array< int > UIScrollDataGrid_obj::get_colours( ){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","get_colours",0x80f0a54d,"com.danielfreeman.extendedmadness.UIScrollDataGrid.get_colours","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",545,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(545)
...
::com::danielfreeman::extendedmadness::UISimpleDataGrid UIScrollDataGrid_obj::get_dataGrid( ){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","get_dataGrid",0x497cdcaa,"com.danielfreeman.extendedmadness.UIScrollDataGrid.get_dataGrid","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",552,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_LINE(552)
...
Float UIScrollDataGrid_obj::set_scrollPositionY( Float value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_scrollPositionY",0xb1164575,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_scrollPositionY","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",556,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(557)
...
Float UIScrollDataGrid_obj::set_scrollPositionX( Float value){
	HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","set_scrollPositionX",0xb1164574,"com.danielfreeman.extendedmadness.UIScrollDataGrid.set_scrollPositionX","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",562,0x0cd2a07e)
	HX_STACK_THIS(this)
	HX_STACK_ARG(value,"value")
	HX_STACK_LINE(563)
...
{
		HX_STACK_FRAME("com.danielfreeman.extendedmadness.UIScrollDataGrid","destructor",0x65a0d78a,"com.danielfreeman.extendedmadness.UIScrollDataGrid.destructor","com/danielfreeman/extendedmadness/UIScrollDataGrid.hx",568,0x0cd2a07e)
		HX_STACK_THIS(this)
		HX_STACK_LINE(569)
...
Dynamic UIScrollDataGrid_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"_dataGridXML") ) { _dataGridXML=inValue.Cast< ::MadXML >(); return inValue; }
		break;
	case 13:
	...
	case 17:
		...
		if (HX_FIELD_EQ(inName,"_columnSlideTimer") ) { _columnSlideTimer=inValue.Cast< ::openfl::utils::Timer >(); return inValue; }
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::MadXML*/ ,(int)offsetof(UIScrollDataGrid_obj,_dataGridXML),HX_CSTRING("_dataGridXML")},
	...
	{hx::fsObject /*::openfl::utils::Timer*/ ,(int)offsetof(UIScrollDataGrid_obj,_columnSlideTimer),HX_CSTRING("_columnSlideTimer")},

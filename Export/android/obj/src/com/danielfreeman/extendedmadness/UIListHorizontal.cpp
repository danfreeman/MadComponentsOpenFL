...
Void UIListHorizontal_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UIListHorizontal_obj > UIListHorizontal_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UIListHorizontal_obj::customCell( Dynamic record,Float position){
{
		...
		if ((!(::com::danielfreeman::madcomponents::UI_obj::isForm(_g)))){
			...
			HX_STACK_LINE(318)
			::MadXML _g4 = ::MadXML_obj::parse(_g3);		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(318)
			this->_renderer = _g4;
		}
		HX_STACK_LINE(320)
		::openfl::display::DisplayObject _g5 = this->newRow((  ((record->__Field(HX_CSTRING("__DOLLAR__renderer"),true))) ? ::MadXML(record->__Field(HX_CSTRING("__DOLLAR__renderer"),true)) : ::MadXML(this->_renderer) ));		HX_STACK_VAR(_g5,"_g5");
		HX_STACK_LINE(320)
		this->_cell = _g5;
		HX_STACK_LINE(321)

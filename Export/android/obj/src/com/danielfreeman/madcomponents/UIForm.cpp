...
Void UIForm_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_row,hx::Null< bool >  __o_inGroup)
{
...
bool inGroup = __o_inGroup.Default(false);
{
	...
	struct _Function_1_1{
		inline static Dynamic Block( ::MadXML &xml,::com::danielfreeman::madcomponents::Attributes &attributes){
	...
	struct _Function_1_3{
		inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::madcomponents::UIForm_obj > __this,::MadXML &xml){
	...
	if (((  ((!(xml->hasNode->resolve(HX_CSTRING("model"))))) ? bool(xml->hasNode->resolve(HX_CSTRING("sendModel"))) : bool(true) ))){
		HX_STACK_LINE(177)
		::MadXML _g24;		HX_STACK_VAR(_g24,"_g24");
		HX_STACK_LINE(177)
		...
		HX_STACK_LINE(177)
		::MadXML _g25;		HX_STACK_VAR(_g25,"_g25");
		HX_STACK_LINE(177)
...
hx::ObjectPtr< UIForm_obj > UIForm_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_row,hx::Null< bool >  __o_inGroup)
...
::MadXML UIForm_obj::set_xml( ::MadXML value){
...
Void UIForm_obj::widthAndHeight( ::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{
...
Void UIForm_obj::parseBlock( ::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,::String mode,bool row){
{
		...
		HX_STACK_LINE(338)
		::MadXMLList xmlList = xml->children(null());		HX_STACK_VAR(xmlList,"xmlList");
		HX_STACK_LINE(339)
		...
		HX_STACK_LINE(351)
		{
			...
			while((true)){
				...
				HX_STACK_LINE(352)
				::MadXML line = xmlList->get(l);		HX_STACK_VAR(line,"line");
				HX_STACK_LINE(353)
...
;
				...
				if (((child != null()))){
					struct _Function_4_1{
						inline static bool Block( ::MadXML &line){
...
Void UIForm_obj::layout( ::com::danielfreeman::madcomponents::Attributes attributes){
{
		...
		this->_positions = Array_obj< Float >::__new();
		HX_STACK_LINE(510)
		::MadXMLList xmlList = this->get_xml()->children(null());		HX_STACK_VAR(xmlList,"xmlList");
		HX_STACK_LINE(511)
		Float pos;		HX_STACK_VAR(pos,"pos");
		struct _Function_1_2{
			inline static bool Block( hx::ObjectPtr< ::com::danielfreeman::madcomponents::UIForm_obj > __this){
...
int UIForm_obj::numberOfColumns( ::MadXMLList xmlList){
	...
	HX_STACK_LINE(687)
	for(::cpp::FastIterator_obj< ::MadXML > *__it = ::cpp::CreateFastIterator< ::MadXML >(xmlList->iterator());  __it->hasNext(); ){
		::MadXML column = __it->next();
...
::openfl::display::DisplayObject UIForm_obj::otherCommands( ::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){

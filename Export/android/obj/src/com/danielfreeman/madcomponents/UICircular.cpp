...
Void UICircular_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UICircular_obj > UICircular_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UICircular_obj::initialise( ::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{

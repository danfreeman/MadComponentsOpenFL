...
Void UIImage_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
HX_STACK_ARG(attributes,"attributes")
{
	...
	if ((xml->hasNode->resolve(HX_CSTRING("data")))){
		...
		if ((xml->node->resolve(HX_CSTRING("data"))->hasNode->resolve(HX_CSTRING("item")))){
			HX_STACK_LINE(80)
			::MadXML _g10 = xml->node->resolve(HX_CSTRING("data"))->node->resolve(HX_CSTRING("item"));		HX_STACK_VAR(_g10,"_g10");
			HX_STACK_LINE(80)
			this->set_data(_g10);
		}
		else{
			HX_STACK_LINE(82)
			::MadXML _g11 = xml->node->resolve(HX_CSTRING("data"));		HX_STACK_VAR(_g11,"_g11");
			HX_STACK_LINE(82)
			this->set_data(_g11);
		}
	}
...
hx::ObjectPtr< UIImage_obj > UIImage_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
::MadXML UIImage_obj::set_data( ::MadXML value){

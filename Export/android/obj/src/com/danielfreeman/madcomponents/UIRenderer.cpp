...
Void UIRenderer_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
{
...
hx::ObjectPtr< UIRenderer_obj > UIRenderer_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes)
...
Void UIRenderer_obj::initialise( ::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes){
{

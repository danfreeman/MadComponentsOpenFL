...
Void UINavigation_obj::__construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_hasNavBar)
{
...
hx::ObjectPtr< UINavigation_obj > UINavigation_obj::__new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_hasNavBar)
...
Void UINavigation_obj::goBack( ::openfl::events::MouseEvent event){
{
		...
		HX_STACK_LINE(293)
		if (((bool(!(this->_slideTimer->running)) && bool(this->_autoBack)))){
			HX_STACK_LINE(294)

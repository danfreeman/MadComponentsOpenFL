...
class HXCPP_CLASS_ATTRIBUTES  UILabelX_obj : public ::com::danielfreeman::madcomponents::UILabel_obj{
	...
	public:
		...
		static hx::ObjectPtr< UILabelX_obj > __new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		virtual Void assignToLabel( ::MadXML xml);

...
class HXCPP_CLASS_ATTRIBUTES  UI_obj : public hx::Object{
	...
	public:
		...
		static ::openfl::display::DisplayObject containers( ::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		static ::com::danielfreeman::madcomponents::UIWindow createPopUp( ::MadXML xml,hx::Null< Float >  width,hx::Null< Float >  height,hx::Null< Float >  curve,hx::Null< bool >  centre);

...
class HXCPP_CLASS_ATTRIBUTES  UIList_obj : public ::com::danielfreeman::madcomponents::UIScrollVertical_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIList_obj > __new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		virtual Void addASearch( ::MadXML xml);
		...
		virtual Void initialiseRenderAttributes( ::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		virtual Dynamic attributesToObject( ::MadXML child);
		...
		virtual ::openfl::display::DisplayObject newRow( ::MadXML rendererXML);
		Dynamic newRow_dyn();

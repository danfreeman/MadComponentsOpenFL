...
class HXCPP_CLASS_ATTRIBUTES  UINavigation_obj : public ::com::danielfreeman::madcomponents::UIPages_obj{
	public:
		...
		UINavigation_obj();
		Void __construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_hasNavBar);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< UINavigation_obj > __new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_hasNavBar);

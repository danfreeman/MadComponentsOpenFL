...
class HXCPP_CLASS_ATTRIBUTES  UIPicker_obj : public ::com::danielfreeman::madcomponents::UIList_obj{
	public:
		...
		UIPicker_obj();
		Void __construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_left,hx::Null< bool >  __o_right,hx::Null< Float >  __o_pickerHeight,hx::Null< Float >  __o_cursorHeight);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< UIPicker_obj > __new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< bool >  __o_left,hx::Null< bool >  __o_right,hx::Null< Float >  __o_pickerHeight,hx::Null< Float >  __o_cursorHeight);

...
class HXCPP_CLASS_ATTRIBUTES  UIWindow_obj : public ::com::danielfreeman::madcomponents::MadSprite_obj{
	public:
		...
		UIWindow_obj();
		Void __construct(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< Float >  __o_curve,hx::Null< bool >  __o_centre);

	public:
		inline void *operator new( size_t inSize, bool inContainer=true)
			{ return hx::Object::operator new(inSize,inContainer); }
		static hx::ObjectPtr< UIWindow_obj > __new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes,hx::Null< Float >  __o_curve,hx::Null< bool >  __o_centre);

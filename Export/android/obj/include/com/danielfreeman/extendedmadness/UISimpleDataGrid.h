...
class HXCPP_CLASS_ATTRIBUTES  UISimpleDataGrid_obj : public ::com::danielfreeman::madcomponents::MadSprite_obj{
	...
	public:
		...
		static hx::ObjectPtr< UISimpleDataGrid_obj > __new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		virtual Array< ::String > extractHeader( ::MadXML xml);

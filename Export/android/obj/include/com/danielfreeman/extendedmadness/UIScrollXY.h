...
class HXCPP_CLASS_ATTRIBUTES  UIScrollXY_obj : public ::com::danielfreeman::madcomponents::UIScrollVertical_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIScrollXY_obj > __new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		bool _stopY;
		Float _tapToScale;
		::openfl::utils::Timer _scaleTimer;

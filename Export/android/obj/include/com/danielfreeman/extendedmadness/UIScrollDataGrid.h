...
class HXCPP_CLASS_ATTRIBUTES  UIScrollDataGrid_obj : public ::com::danielfreeman::extendedmadness::UIScrollXY_obj{
	...
	public:
		...
		static hx::ObjectPtr< UIScrollDataGrid_obj > __new(::openfl::display::Sprite screen,::MadXML xml,::com::danielfreeman::madcomponents::Attributes attributes);
		...
		::openfl::utils::Timer _columnSlideTimer;
		...
		virtual ::MadXML noChildren( ::MadXML xml);
